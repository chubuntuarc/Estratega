...
$df100 = $_POST['f15'];
$dm100 = $_POST['d100Dll'];
$d100 = $euros100 + $dm100 + ($df100 * 100) - $_POST['f25'] - $_POST['m100S'];
$df50 = $_POST['f16'];
$dm50 = $_POST['d50Dll'];
$d50 = $euros50 + $dm50 + ($df50 * 100) - $_POST['f26'] - $_POST['m50S'];
$df20 = $_POST['f17'];
$dm20 = $_POST['d20Dll'];
$d20 = $euros20 + $dm20 + ($df20 * 100) - $_POST['f27'] - $_POST['m20S'];
$df10 = $_POST['f18'];
$dm10 = $_POST['d10Dll'];
$d10 = $euros10 + $dm10 + ($df10 * 100) - $_POST['f28'] - $_POST['m10S'];
$df5 = $_POST['f19'];
$dm5 = $_POST['d5Dll'];
$d5 = $euros5 + $dm5 + ($df5 * 100) - $_POST['f29'] - $_POST['m5S'];
$df2 = $_POST['f20'];
$dm2 = $_POST['d2Dll'];
$d2 = $euros2 + $dm2 + ($df2 * 100) - $_POST['f30'] - $_POST['m2S'];
$df1 = $_POST['f21'];
$dm1 = $_POST['d1Dll'];
$d1 = $euros1 + $dm1 + ($df1 * 100) - $_POST['f31'] - $_POST['m1S'];


if ($pesosAnt >= $peso && $totalCambio == 0.00) {
    $query = "UPDATE arqueo SET e100 = $d100 , e50 = $d50 , e20 = $d20 , e10 = $d10 , e5 = $d5 , e2 = $d2 , e1 = $d1 where usuario = '$nom'";
   $resultado = mysql_query($query);  
}
else
{
