...
$df100 = $_POST['f15'];
$dm100 = $_POST['d100Dll'];
$d100 = $euros100 - $dm100 - ($df100 * 100);
$df50 = $_POST['f16'];
$dm50 = $_POST['d50Dll'];
$d50 = $euros50 - $dm50 - ($df50 * 100);
$df20 = $_POST['f17'];
$dm20 = $_POST['d20Dll'];
$d20 = $euros20 - $dm20 - ($df20 * 100);
$df10 = $_POST['f18'];
$dm10 = $_POST['d10Dll'];
$d10 = $euros10 - $dm10 - ($df10 * 100);
$df5 = $_POST['f19'];
$dm5 = $_POST['d5Dll'];
$d5 = $euros5 - $dm5 - ($df5 * 100);
$df2 = $_POST['f20'];
$dm2 = $_POST['d2Dll'];
$d2 = $euros2 - $dm2 - ($df2 * 100);
$df1 = $_POST['f21'];
$dm1 = $_POST['d1Dll'];
$d1 = $euros1 - $dm1 - ($df1 * 100);
