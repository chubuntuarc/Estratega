...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="item col-xs-12 col-lg-7">
                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                ...
                                <form>
                                <div id="partea">
                                    <input id="divisaConv" type="text" placeholder="Euros" onkeypress="divisa(this.form)" name="divisaConv" tabindex=1 autofocus autocomplete="off">
                                </div>
                                <div id="parteb">
                                 <?php include_once("php/tipo_cambio_dv_eurocompra.php"); ?><!--Obtener el tipo de cambio a la compra-->
    ...
    <?php include_once("php/compra_euros.php"); ?><!--Operaciones de la compra de euros-->
</div>
