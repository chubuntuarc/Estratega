...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="item col-xs-12 col-lg-7">
                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                ...
                                <form>
                                <div id="partea">
                                    <input id="divisaConv" type="text" placeholder="Dll Can" onkeypress="divisa(this.form)" name="divisaConv" tabindex=1 autofocus>
                                </div>
                                <div id="parteb">
                                 <?php 
                                    $con = mysql_connect($host,$user,$pw) or die ("No se pudo establecer la conexión");
    ...
    <?php 
     ...
     <?php 
            ...
            $con = mysql_connect($host,$user,$pw) or die ("No se pudo establecer la conexión");
            mysql_select_db($db, $con) or die ("No se pudo conectar a la base de datos");
            $query = "SELECT * FROM calculo_arqueo WHERE divisa = 'canadienses' and usuario = '$nom'";
            $resultado = mysql_query($query);
            while ($fila = mysql_fetch_array($resultado)) {
     ...
     <?php 
            ...
            mysql_select_db($db, $con) or die ("No se pudo conectar a la base de datos");
            if ($pesosAnt >= $peso && $difPeso == 0.00 && $difDolar == 0.00) {
                $query = "UPDATE calculo_arqueo SET d100 = $arq100D, d50 = $arq50D, d20 = $arq20D, d10 = $arq10D, d5 = $arq5D,d2 = $arq2D, d1 = $arq1D WHERE divisa = 'canadienses' and usuario = '$nom'";
               $resultado = mysql_query($query);
            }            
     ?>
</div>
