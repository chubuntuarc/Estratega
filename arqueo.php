...
<div class="row" >
    <div class="item col-xs-12 col-lg-6">
        <div class="panel panel-default paper-shadow" data-z="0.5">
            <div class="panel-heading">
                <h4 class="text-headline margin-none">Arqueo Pesos</h4>
                <p class="text-subhead text-light">Registre el arqueo de los pesos en su caja</p>
            </div>
    ...
    <table>
        ...
        <tr>
            <td>1000.00</td>
            <td><input type="text" placeholder="0" id="f1" name="f1" onkeypress="fajilla1000P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f22" name="f22" onkeypress="fajilla1000PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>500.00</td>
            <td><input type="text" placeholder="0" id="f2" name="f2" onkeypress="fajilla500P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f23" name="f23" onkeypress="fajilla500PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>200.00</td>
            <td><input type="text" placeholder="0" id="f3" name="f3" onkeypress="fajilla200P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f24" name="f24" onkeypress="fajilla200PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>100.00</td>
            <td><input type="text" placeholder="0" id="f4" name="f4" onkeypress="fajilla100P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f15" name="f15" onkeypress="fajilla100D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f25" name="f25" onkeypress="fajilla100PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>50.00</td>
            <td><input type="text" placeholder="0" id="f5" name="f5" onkeypress="fajilla50P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f16" name="f16" onkeypress="fajilla50D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f26" name="f26" onkeypress="fajilla50PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>20.00</td>
            <td><input type="text" placeholder="0" id="f6" name="f6" onkeypress="fajilla20P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f17" name="f17" onkeypress="fajilla20D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f27" name="f27" onkeypress="fajilla20PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>10.00</td>
            <td><input type="text" placeholder="0" id="f7" name="f7" onkeyup="fajilla10P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f18" name="f18" onkeypress="fajilla10D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f28" name="f28" onkeypress="fajilla10PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>5.00</td>
            <td><input type="text" placeholder="0" id="f8" name="f8" onkeypress="fajilla5P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f19" name="f19" onkeypress="fajilla5D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f29" name="f29" onkeypress="fajilla5PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>2.00</td>
            <td><input type="text" placeholder="0" id="f9" name="f9" onkeypress="fajilla2P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f20" name="f20" onkeypress="fajilla2D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f30" name="f30" onkeypress="fajilla2PS(this.form)" autocomplete="off"></td>
        ...
        <tr>
            <td>1.00</td>
            <td><input type="text" placeholder="0" id="f10" name="f10" onkeypress="fajilla1P(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f21" name="f21" onkeypress="fajilla1D(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f31" name="f31" onkeypress="fajilla1PS(this.form)" autocomplete="off"></td>
         ...
         <tr>
            <td>0.50</td>
            <td><input type="text" placeholder="0" id="f11" name="f11" onkeypress="fajilla50C(this.form)" autocomplete="off"></td>
            ...
            <td><input type="text" placeholder="0" id="f32" name="f32" onkeypress="fajilla50CS(this.form)" autocomplete="off"></td>
