                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="item col-xs-12 col-lg-7">
                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                ...
                                <div id="parte2">
                                    <?php include_once("php/tipo_cambio_dveuro.php"); ?><!--Obtener el tipo de cambio a la venta-->
...
<div class="row" >
    ...
    <table>
      ...
      <?php include_once("php/venta_euros.php"); ?><!--Operaciones de la venta de dólares-->
</div>
