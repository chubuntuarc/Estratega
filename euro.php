...
<head>
    ...
    <title>Estratega Venta Euros</title>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="item col-xs-12 col-lg-7">
                            <div class="panel panel-default paper-shadow" data-z="0.5">
                                ...
                                <form>
                                  <div id="parte1">
                                    <input id="divisaConv" type="text" placeholder="Euros"  onkeypress="divisa(this.form)"  name="divisaConv" tabindex=1 autofocus>
                                </div>
                                <div id="parte4">
                                <a href="vendedor.php">Dólares</a>
                                <a href="canada.php">Canadienses</a>
                                <a id="seleccionado" href="euro.php">Euros</a>
                               </div>  
                                <div id="parte2">
                                    <?php 
                                    $con = mysql_connect($host,$user,$pw) or die ("No se pudo establecer la conexión");
    ...
    <?php 
     ...
     <?php 
            ...
            $con = mysql_connect($host,$user,$pw) or die ("No se pudo establecer la conexión");
            mysql_select_db($db, $con) or die ("No se pudo conectar a la base de datos");
            $query = "SELECT * FROM calculo_arqueo WHERE divisa = 'euros' and usuario = '$nom'";
            $resultado = mysql_query($query);
            while ($fila = mysql_fetch_array($resultado)) {
     ...
     <?php 
            ...
            mysql_select_db($db, $con) or die ("No se pudo conectar a la base de datos");
            if ($dolarAnt >= $dolar && $difPeso == 0.00 && $difDolar == 0.00) {
                $query = "UPDATE calculo_arqueo SET d100 = $arq100D, d50 = $arq50D, d20 = $arq20D, d10 = $arq10D, d5 = $arq5D,d2 = $arq2D, d1 = $arq1D WHERE divisa = 'euros' and usuario = '$nom'";
               $resultado = mysql_query($query);
            }            
     ?>
</div>
